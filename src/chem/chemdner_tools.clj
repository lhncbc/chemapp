...
(defn load-chemdner-abstracts [filename]
  (doall
   (map 
    (fn [line]
      (vec (.split line "\t")))
...
;;
;; chemdner_ann_training_13-07-31.txt
;;
...
;; indexing (CDI) sub-task: cdi_ann_training_13-07-31.txt
;;
...
;;    recognition (CEM) sub-task: cem_ann_training_13-07-31.txt
;;
...
(defn load-training-mention-gold-standard [filename]
  (map 
   (fn [line]
