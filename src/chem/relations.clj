...
(defn collect-relations [subject-cui rela]
  ...
  (m/fetch :mrrel :where {:cui1 subject-cui :rela rela}))
...
;; user> (def monosaccharide-isa-relations (chem.relations/collect-relations "C0026492" "isa"))
;; #'user/monosaccharide-isa-relations
;; user> (count monosaccharide-isa-relations)
;; 40
;; user> (def monosaccharide-cuis (set (map #(:cui2 %) monosaccharide-isa-relations)))
;; #'user/monosaccharide-cuis
;; user> (count monosaccharide-cuis)
;; 28
;; user> (def disaccharide-isa-relations (chem.relations/collect-relations "C0012611" "isa"))
...
;; 10
;; user> (def aminoglycoside-isa-relations (chem.relations/collect-relations "C0002556" "isa"))
;; #'user/aminoglycoside-isa-relations
;; user> (count aminoglycoside-isa-relations)
;; 75
;; user> (def aminoglycoside-cuis  (set (map #(:cui2 %) aminoglycoside-isa-relations)))
